...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 List<Integer> neighbors_2 = new ArrayList<Integer>();
		
		 for(int neighbor : getNeighbors(v)) {
			 List<Integer> his_neighbors = new ArrayList<Integer>();
			 his_neighbors = getNeighbors(neighbor);
			 neighbors_2.addAll(his_neighbors);
		 }
		 return neighbors_2;
	}
